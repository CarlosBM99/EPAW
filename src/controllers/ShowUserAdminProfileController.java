 ...
 */
@WebServlet("/ShowUserAdminProfileController")
public class ShowUserAdminProfileController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private DAO db;
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowUserAdminProfileController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("ShowUserAdminProfileController.");
		...
		try {
			...
			if(result.next()){
				...
				RequestDispatcher dispatcher = request.getRequestDispatcher("ShowUserAdminProfile.jsp");
