...
<%
	BeanUser post = new BeanUser();
	HttpSession session = request.getSession();		
%>
			<div class="text-center">
				<h3>Followed Users</h3>
				<h4>Users</h4>
				<div id="my_followed_users" style="margin-bottom: 30px">
				<%
			...
			for(int i=size-1; i>=0; i--){
				out.println(
				  ...
				  "<div class='card-header' id='nickname_" + posts[i].getNickname() + "'>"+
				    posts[i].getNickname()+
				  "</div>"+
				  "<div class='card-body'>"+
				    "<p class'card-text'>"+
				  posts[i].getFirstname()+ " " + posts[i].getLastname()+
				  "</p>"+
	...
	var my_followed_users = document.querySelector("#my_followed_users");
	var size = my_followed_users.childNodes.length -1;
	for(var i=size-1; i>=1; i=i-2){
		var id = my_followed_users.childNodes[i].childNodes[0].id
